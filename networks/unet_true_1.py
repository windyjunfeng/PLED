...
class UNet_true_1(nn.Module):
    ...
    def __init__(
        ...
        def _create_block(
            ...
            return self._get_connection_block(down, up, subblock, bottom_flag)

        self.model = _create_block(in_channels, out_channels, self.channels, self.strides, True)

    def _get_connection_block(self, down_path: nn.Module, up_path: nn.Module, subblock: nn.Module, bottom_flag=False) -> nn.Module:
        """
