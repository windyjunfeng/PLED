...
output_root_path=r'G:\zhoujunfeng_g\code\deep_learning_e-field_large_files\evaluation\results_analysis\optimization_evaluation\visualization'
...
sub_foldername=r'box_plot_viridis'
...
for classname in classnames.keys():
    ...
    for aspect in aspects.keys():
        ...
        plt.figure()
        ax=sns.boxplot(data=data, x='Methods', y=aspects[aspect], hue='Methods', linewidth=1.5, showfliers=False, palette='viridis')  # 不显示离群点
        # ax.legend_.remove()
