...
def inference_efield(temp_img_path,temp_seg_path, weight_path,output_path):
...
if __name__ == "__main__":
    ...
    # temp_img_rootpath = r'/root/autodl-tmp/tms_e-field_scalp_data/segmentation/image'
    # temp_seg_rootpath = r'/root/autodl-tmp/tms_e-field_scalp_data/segmentation/label'
    ...
    # output_rootpath = r'/root/autodl-tmp/tms_e-field_scalp_data/efield_calculation/inference/local_img2efield'
    ...
    temp_seg_rootpath = r'/media/irc300/d37c3a3a-b751-4342-9504-f7ee31232551/windyjunfeng/data/deep_learning_e-field/TMS-EEG_lesion_cortex/m2m_files_add_lesion'
    ...
    for line in lines:
        ...
        output_path = os.path.join(output_rootpath, line.rstrip('\n'),'inference/local_efield_35')
        inference_efield(temp_img_path, temp_seg_path, weight_path, output_path)