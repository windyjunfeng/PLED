...
def inference_efield_vector(temp_img_path, weight_path,output_path):
...
if __name__ == "__main__":
    ...
    weight_path = r'/data/disk_2/zhoujunfeng/code/efield_calculation/weights/46_best_metric_model_efieldcal_vector_array_true_1_interpolate.pth'
    ...
    for line in lines:
        ...
        output_path = os.path.join(output_rootpath,line.rstrip('\n'),'inference/local_efield_vector_unet_true_1_new_1010_center_based_gt')
        inference_efield_vector(temp_img_path, weight_path, output_path)
    ...
    # weight_path = r'/data/disk_2/zhoujunfeng/code/efield_calculation/weights/46_best_metric_model_efieldcal_vector_array_true_1_interpolate.pth'
    # output_path = r'/data/disk_1/zhoujf/large_data/e-field_dataset/cohort_lab_health/m2m_A9/inference/local_efield_vector_unet_true_1_new_1010_center_based_gt'
    # inference_efield_vector(temp_img_path, weight_path, output_path)