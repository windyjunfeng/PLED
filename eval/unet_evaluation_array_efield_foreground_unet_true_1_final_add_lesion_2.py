...
def main(temp_img_path,temp_label_path,split_test_txt,weight_path, dAdt_file, output_dir):
    ...
    category_names = ['5','9','11','12','13','14','15','19']
...
if __name__ == "__main__":
    ...
    output_dir=r'/media/irc300/d37c3a3a-b751-4342-9504-f7ee31232551/windyjunfeng/data/deep_learning_e-field/TMS-EEG_lesion_cortex/evaluation/efield_calculation/39_based_gtlabel_add_lesion'
