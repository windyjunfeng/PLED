...
def main(temp_img_path,temp_label_path,split_train_txt,split_val_txt,dAdt_file,weight_path):
    num_classes = 1
        ...
        if (epoch + 1) % val_interval == 0:
            ...
            with torch.no_grad():
                ...
                if metric < best_metric:
                    ...
                    torch.save(model.state_dict(), "41_best_metric_model_efieldcal_array_fusion_1_new_nointerpolate.pth")
...
if __name__ == "__main__":
    ...
    temp_img_path=r'/root/autodl-tmp/tms_e-field_scalp_data/segmentation/inference/local_seg_small_train'
    temp_label_path=r'/root/autodl-tmp/tms_e-field_scalp_data/efield_calculation/local_efield'
    # temp_label_path = r'/root/autodl-tmp/tms_e-field_scalp_data/efield_calculation/local_efield_nointerpolate'
    # split_train_txt=r'/root/autodl-tmp/tms_e-field_scalp_data/train_l.txt'
    # split_val_txt=r'/root/autodl-tmp/tms_e-field_scalp_data/val_l.txt'
    split_train_txt = r'/root/autodl-tmp/tms_e-field_scalp_data/train_s.txt'
    split_val_txt = r'/root/autodl-tmp/tms_e-field_scalp_data/val_s.txt'
    dAdt_file=r'/root/autodl-tmp/tms_e-field_scalp_data/efield_calculation/dadt_norm_808032_0mm_fmm3d.npy'
    weight_path=r'/autodl-fs/data/code/deep_learning_efield/segmentation/unet/38_best_metric_model_efieldcal_array_fusion_1_new_interpolate.pth'
    main(temp_img_path,temp_label_path,split_train_txt,split_val_txt,dAdt_file,weight_path)
