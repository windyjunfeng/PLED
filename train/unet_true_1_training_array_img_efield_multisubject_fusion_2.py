...
from networks.unet_true_1_fusion_2 import UNet_true_1_fusion_2
        ...
        if (epoch + 1) % val_interval == 0:
            ...
            with torch.no_grad():
                ...
                if metric < best_metric:
                    ...
                    torch.save(model.state_dict(), "best_metric_model_efieldcal_array_fusion_2.pth")
