...
from networks.unet_true_1_fusion_3 import UNet_true_1_fusion_3
        ...
        if (epoch + 1) % val_interval == 0:
            ...
            with torch.no_grad():
                ...
                if metric < best_metric:
                    ...
                    torch.save(model.state_dict(), "best_metric_model_efieldcal_array_fusion_3.pth")
