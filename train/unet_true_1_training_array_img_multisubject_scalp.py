...
def main(temp_img_path,temp_label_path,split_train_txt,split_val_txt):
    ...
    train_loader = DataLoader(train_ds, batch_size=16, shuffle=True, num_workers=16, pin_memory=torch.cuda.is_available())
    # create a validation data loader
    val_ds = ImageDataset(val_imgs, val_labels, transform=val_imtrans, seg_transform=val_segtrans)
    val_loader = DataLoader(val_ds, batch_size=16, num_workers=16, pin_memory=torch.cuda.is_available())
    ...
    # weight_path=r'/root/autodl-fs/code/deep_learning_efield/segmentation/unet/32_best_metric_model_segmentation3d_array_scalp_true_1_all.pth'
        ...
        if (epoch + 1) % val_interval == 0:
            ...
            with torch.no_grad():
                ...
                if metric > best_metric:
                    ...
                    torch.save(model.state_dict(), "best_metric_model_segmentation3d_array_scalp_true_1.pth")
...
if __name__ == "__main__":
    ...
    split_train_txt=r'/root/autodl-tmp/tms_e-field_scalp_data/segmentation/train_s.txt'
    split_val_txt=r'/root/autodl-tmp/tms_e-field_scalp_data/segmentation/val_s.txt'
