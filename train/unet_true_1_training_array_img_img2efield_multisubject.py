        ...
        if (epoch + 1) % val_interval == 0:
            ...
            with torch.no_grad():
                ...
                for val_data in val_loader:
                    ...
                    mse_loss_ = torch.sqrt(torch.sum((val_outputs - val_labels) ** 2, dim=(1,2,3,4)))  # batch size尽量不要设为1
                    if mse_loss is None:
                ...
                if metric < best_metric:
                    ...
                    torch.save(model.state_dict(), "best_metric_model_img2efieldcal_array_true_1_interpolate.pth")
