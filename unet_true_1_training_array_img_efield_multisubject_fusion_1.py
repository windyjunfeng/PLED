        ...
        if (epoch + 1) % val_interval == 0:
            ...
            with torch.no_grad():
                ...
                if metric < best_metric:
                    ...
                    torch.save(model.state_dict(), "best_metric_model_efieldcal_array_fusion_1_new_nointerpolate_all.pth")
...
if __name__ == "__main__":
    temp_img_path=r'/media/irc300/d37c3a3a-b751-4342-9504-f7ee31232551/windyjunfeng/data/deep_learning_e-field/TMS-EEG_lesion_cortex'
    # temp_label_path=r'/root/autodl-tmp/tms_e-field_scalp_data/efield_calculation/local_efield'
    temp_label_path = r'/media/irc300/d37c3a3a-b751-4342-9504-f7ee31232551/windyjunfeng/data/deep_learning_e-field/TMS-EEG_lesion_cortex'
    ...
    split_train_txt = r'/media/irc300/d37c3a3a-b751-4342-9504-f7ee31232551/windyjunfeng/data/deep_learning_e-field/TMS-EEG_lesion_cortex/train.txt'
    split_val_txt = r'/media/irc300/d37c3a3a-b751-4342-9504-f7ee31232551/windyjunfeng/data/deep_learning_e-field/TMS-EEG_lesion_cortex/val.txt'
